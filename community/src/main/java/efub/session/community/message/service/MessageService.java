package efub.session.community.message.service;
...
import efub.session.community.message.repository.MessageRepository;
...
import efub.session.community.messageroom.repository.MessageRoomRepository;
